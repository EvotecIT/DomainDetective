...
/// <summary>Creates an SMTP TLS desired state policy fragment.</summary>
/// <para>The returned object is intended to be used with New-DDDesiredState or applied to an existing configuration.</para>
/// <example>
///   <summary>Require strong SMTP TLS posture</summary>
///   <prefix>PS&gt; </prefix>
///   <code>New-DDDesiredStateSmtpTls -RequireCertificateValid $true -DisallowLegacyProtocols $true -MinimumGradeLevel B</code>
/// </example>
[Cmdlet(VerbsCommon.New, "DDDesiredStateSmtpTls")]
[OutputType(typeof(DesiredStateProfile))]
public sealed class CmdletNewDesiredStateSmtpTls : PSCmdlet {
    /// <para>Enable/disable the SMTP TLS desired state module.</para>
    ...
    /// <summary>Creates an SMTP TLS policy fragment as a DesiredStateProfile.</summary>
