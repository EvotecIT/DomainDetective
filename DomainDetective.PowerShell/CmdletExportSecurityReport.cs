...
public sealed class CmdletExportSecurityReport : ExportableAsyncPSCmdlet {
    /// <summary>Objects to compose (SPF/DKIM/DMARC view objects recommended).</summary>
            ...
            try {
                switch (fmt) {
                    ...
                    case DomainDetective.Reports.ReportFormat.Html:
                        DomainDetective.Reports.Html.HtmlCompositionReport.Generate(outPath, _items, Scope, OpenInBrowser.IsPresent || ExportDefaults.OpenInBrowser);
                        break;
                    default:
