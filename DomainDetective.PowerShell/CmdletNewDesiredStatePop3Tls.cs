...
/// <summary>Creates a POP3 TLS desired state policy fragment.</summary>
/// <para>The returned object is intended to be used with New-DDDesiredState or applied to an existing configuration.</para>
/// <example>
///   <summary>Require strong POP3 TLS posture</summary>
///   <prefix>PS&gt; </prefix>
///   <code>New-DDDesiredStatePop3Tls -RequireCertificateValid $true -DisallowLegacyProtocols $true -MinimumGradeLevel B</code>
/// </example>
[Cmdlet(VerbsCommon.New, "DDDesiredStatePop3Tls")]
[OutputType(typeof(DesiredStateProfile))]
public sealed class CmdletNewDesiredStatePop3Tls : PSCmdlet {
    /// <para>Enable/disable the POP3 TLS desired state module.</para>
    ...
    /// <summary>Creates a POP3 TLS policy fragment as a DesiredStateProfile.</summary>
