...
### EXAMPLE 1
```powershell
PS> New-DDDesiredStateMailLatency -Enabled $true -RequireAllConnectSuccess $true -MaxConnectTimeMs 2000 -MaxBannerTimeMs 2000
```
