...
### EXAMPLE 1
```powershell
PS> New-DDDesiredStateStartTls -RequireAllServersSupported $true -DisallowDowngradeDetected $true
```


## PARAMETERS

### -DisallowDowngradeDetected
