...
### ByName (Default)
```powershell
Get-DDApexAddressInfo [-DomainName] <string[]> [[-DnsEndpoint] <DnsEndpoint>] [-DisableParallel] [-ThrottleLimit <Int32>] [-MaxParallelism <Int32>] [-DnsParallelism <Int32>] [-DnsEndpoints <DnsEndpoint[]>] [-MultiResolverStrategy <MultiResolverStrategy>] [-MultiResolverMaxParallelism <Int32>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Get-DDApexAddressInfo -DisableParallel
```
...
- `DomainDetective.Views.ApexAddressInfo`
