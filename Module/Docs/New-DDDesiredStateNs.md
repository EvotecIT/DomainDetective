...
### EXAMPLE 1
```powershell
PS> New-DDDesiredStateNs -RequireAtLeastTwo $true -DisallowDuplicates $true
```
...
### -AllowedHostSuffixes
Allowed host suffixes for authoritative NS targets.
