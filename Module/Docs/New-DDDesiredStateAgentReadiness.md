...
schema: 2.0.0
---
# New-DDDesiredStateAgentReadiness
## SYNOPSIS
...
### EXAMPLE 1
```powershell
PS> New-DDDesiredStateAgentReadiness -MinimumScore 70 -RequireLlmsTxt $true -RequireMarkdown $true -RequireApiCatalog $true
```
