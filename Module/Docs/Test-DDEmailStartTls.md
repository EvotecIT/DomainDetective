...
### EXAMPLE 1
```powershell
Test-DDEmailStartTls -DomainName example.com -Port 587
```
...
### -FullResponse
Return the full analysis object instead of per-server details.
