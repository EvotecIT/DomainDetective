...
### EXAMPLE 1
```powershell
Test-DDDirectoryExposure -DomainName example.com
```


### EXAMPLE 2
```powershell
Test-DDDirectoryExposure -DomainName example.com -UseHttps
```
...
- `DomainDetective.Views.DirectoryExposureInfo`
