...
### __AllParameterSets
```powershell
Get-DDTlsRptReportsTimeSeries [-DomainName] <string[]> -StorePath <string> [-SinceUtc <datetime>] [-Days <int>] [<CommonParameters>]
```
...
- `DomainDetective.Views.TlsRptReportsTimeSeriesInfo`
