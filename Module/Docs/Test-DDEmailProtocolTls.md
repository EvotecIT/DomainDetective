...
## DESCRIPTION
Returns view objects with full raw analysis attached at Raw.

## EXAMPLES

### EXAMPLE 1
```powershell
Test-DDEmailProtocolTls -DomainName example.com
```


### EXAMPLE 2
```powershell
Test-DDEmailProtocolTls -DomainName example.com -Protocol Smtp
```
...
### -Protocol
Select mail protocols to evaluate.

```yaml
Type: String[]
Parameter Sets: ServerName
Aliases: None
Possible values: Smtp, Imap, Pop3
...
- `DomainDetective.Views.MailTlsInfo`
