...
($spf + $dnsbl) | Export-DDSecurityReport -Scope Detailed -ExportFormat Html -ExportPath "$PSScriptRoot\Reports" -OpenReport

Export-DDSecurityReport -Scope Detailed -ExportFormat Html -ExportPath "$PSScriptRoot\Reports" -OpenReport {
