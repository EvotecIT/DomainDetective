...
($spf + $dnsbl) | Export-DDSecurityReport -Scope Detailed -ExportFormat Markdown -ExportPath "$PSScriptRoot\Reports" -OpenReport

Export-DDSecurityReport -Scope Detailed -ExportFormat Markdown -ExportPath "$PSScriptRoot\Reports" -OpenReport {
