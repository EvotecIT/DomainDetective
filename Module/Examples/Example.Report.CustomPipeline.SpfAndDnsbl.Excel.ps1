...
($spf + $dnsbl) | Export-DDSecurityReport -Scope Detailed -ExportFormat Excel -ExportPath "$PSScriptRoot\Reports" -OpenReport

Export-DDSecurityReport -Scope Detailed -ExportFormat Excel -ExportPath "$PSScriptRoot\Reports" -OpenReport {
