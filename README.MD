...
Invoke-DDCertificateInventory -DomainName example.com -CacheDirectory .\\cert-monitor -IncludeCtSubdomains -VerifyCtSubdomains -MaxTargets 150 -MaxProbeStartsPerSecond 20 -MaxProbeErrorWarnings 10 -Verbose
