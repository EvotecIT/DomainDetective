...
public static class SectionOrdering
{
    ...
    public static string? SectionKeyFor(HealthCheckType h) => h switch
    {
        ...
        HealthCheckType.MICROSOFT365 => "Microsoft 365",
        HealthCheckType.HTTP => "HTTP",
        HealthCheckType.SITEMAP => "Sitemap",
        HealthCheckType.AGENTREADINESS => "Agent Readiness",
        HealthCheckType.TYPOSQUATTING => "Typosquatting",
        HealthCheckType.CTTIMELINE => "CT Timeline",
        HealthCheckType.SUBDOMAINS => "Subdomains",
        HealthCheckType.DNSINVENTORY => "DNS Inventory",
        HealthCheckType.DNSTRACE => "DNS Trace",
        HealthCheckType.DNSPROPAGATION => "DNS Propagation",
        HealthCheckType.DNSAMPLIFICATION => "DNS Amplification",
        HealthCheckType.DNSOVERTLS => "DNS over TLS",
        HealthCheckType.IPENRICHMENT => "IP Enrichment",
    ...
    public static string NormalizeSection(string s)
    {
        ...
        return u switch
        {
            ...
            "M365" => "Microsoft 365",
            "MICROSOFTTENANT" => "Microsoft 365",
            "M365TENANT" => "Microsoft 365",
            "ENTRA" => "Microsoft 365",
            "HTTP" => "HTTP",
            "SITEMAP" => "Sitemap",
            "XMLSITEMAP" => "Sitemap",
            ...
            "AGENTREADY" => "Agent Readiness",
            "AIREADINESS" => "Agent Readiness",
            "AIAGENTREADINESS" => "Agent Readiness",
            "TYPOSQUATTING" => "Typosquatting",
            "TYPO" => "Typosquatting",
            "LOOKALIKE" => "Typosquatting",
            "CTTIMELINE" => "CT Timeline",
            "CERTIFICATETRANSPARENCY" => "CT Timeline",
