...
namespace DomainDetective.Tests {
    public class TestDnssecInvalidDs {
        ...
        [Fact]
        public void TruncatedMatchingPrefixDoesNotValidate() {
            var dnskey = "257 3 13 mdsswUyr3DPW132mOi8V9xESWE8jTo0dxCjjnopKl+GqJxpVXckHAeF+KkxLbxILfDLUT0rAK9iUzy1L53eKGQ==";
            var truncated = "2371 ECDSAP256SHA256 2 c988ec423e3880eb8dd8a46fe06ca230";
            var method = typeof(DnsSecAnalysis).GetMethod("VerifyDsMatch", BindingFlags.NonPublic | BindingFlags.Static)!;

            bool result = (bool)method.Invoke(null, new object[] { dnskey, truncated, "cloudflare.com" })!;

            Assert.False(result);
        }

        [Fact]
        public void UnsupportedDigestTypeDoesNotFallBackToSha256() {
            var dnskey = "257 3 13 mdsswUyr3DPW132mOi8V9xESWE8jTo0dxCjjnopKl+GqJxpVXckHAeF+KkxLbxILfDLUT0rAK9iUzy1L53eKGQ==";
            var dsRecord = "2371 ECDSAP256SHA256 3 c988ec423e3880eb8dd8a46fe06ca230ee23f35b578d64e78b29c3e1c83d245a";
            var method = typeof(DnsSecAnalysis).GetMethod("VerifyDsMatch", BindingFlags.NonPublic | BindingFlags.Static)!;

            bool result = (bool)method.Invoke(null, new object[] { dnskey, dsRecord, "cloudflare.com" })!;
