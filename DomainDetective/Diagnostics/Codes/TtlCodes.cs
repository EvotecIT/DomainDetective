namespace DomainDetective;
	...
	internal static class TtlCodes {
	    ...
	    public const string NonUniformAcrossNS_TXT_MTASTS = "DNS.TTL.TXT.MTASTS.NonUniformAcrossNS";
	    public const string UniformAcrossNS_TXT_MTASTS = "DNS.TTL.Success.TXT.MTASTS.UniformAcrossNS";
	    public const string NonUniformAcrossNS_TXT_TLSRPT = "DNS.TTL.TXT.TLSRPT.NonUniformAcrossNS";
	    public const string UniformAcrossNS_TXT_TLSRPT = "DNS.TTL.Success.TXT.TLSRPT.UniformAcrossNS";
