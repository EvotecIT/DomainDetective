...
internal static class DetectedDnsApplicationCatalog {
    ...
    private static readonly IReadOnlyList<TxtDefinition> TxtDefinitions = new[] {
        ...
        new TxtDefinition { Id = "mailchimp", Name = "Mailchimp", Category = DetectedDnsAppCategory.EmailMarketing, Match = static value => value.IndexOf("mailchimp", StringComparison.OrdinalIgnoreCase) >= 0 },
        new TxtDefinition { Id = "salesforce-marketing-cloud", Name = "Salesforce Marketing Cloud", Category = DetectedDnsAppCategory.EmailMarketing, Match = static value => value.IndexOf("sfmc-", StringComparison.OrdinalIgnoreCase) >= 0 || value.IndexOf("salesforce", StringComparison.OrdinalIgnoreCase) >= 0 },
        ...
        new TxtDefinition { Id = "hubspot-email", Name = "HubSpot Email", Category = DetectedDnsAppCategory.EmailMarketing, Match = static value => value.IndexOf("hubspot", StringComparison.OrdinalIgnoreCase) >= 0 },
        new TxtDefinition { Id = "exclaimer", Name = "Exclaimer", Category = DetectedDnsAppCategory.EmailSignatures, Match = static value => value.IndexOf("exclaimer", StringComparison.OrdinalIgnoreCase) >= 0 },
        ...
        new TxtDefinition { Id = "docusign", Name = "DocuSign", Category = DetectedDnsAppCategory.Productivity, Match = static value => value.IndexOf("docusign=", StringComparison.OrdinalIgnoreCase) >= 0 || value.IndexOf("docusign", StringComparison.OrdinalIgnoreCase) >= 0 },
        ...
        new TxtDefinition { Id = "openai", Name = "OpenAI", Category = DetectedDnsAppCategory.Security, Match = static value => value.IndexOf("openai-domain-verification=", StringComparison.OrdinalIgnoreCase) >= 0 },
        new TxtDefinition { Id = "anthropic", Name = "Anthropic", Category = DetectedDnsAppCategory.Security, Match = static value => value.IndexOf("anthropic-domain-verification-", StringComparison.OrdinalIgnoreCase) >= 0 },
