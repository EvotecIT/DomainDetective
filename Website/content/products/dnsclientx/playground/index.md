...
<div class="dns-playground">
  <section class="dns-playground__panel">
    <div class="dns-playground__heading">
      ...
      <p>The live preview uses public DNS JSON endpoints that support browser CORS. The generated code blocks show the closest DnsClientX equivalent for your chosen domain, record type, provider preview, and DNSSEC intent.</p>
    </div>

    <form id="dns-playground-form" class="dns-playground__form">
      <label class="dns-playground__field dns-playground__field--wide">
        <span>DNS name</span>
      ...
      <div class="dns-playground__actions">
        <button class="dd-button dd-button-primary" type="submit">Resolve</button>
        <a id="dns-direct-link" class="dd-button dd-button-ghost" href="https://dns.google/resolve?name=evotec.pl&amp;type=A" target="_blank" rel="noopener">Open direct JSON query</a>
      </div>
