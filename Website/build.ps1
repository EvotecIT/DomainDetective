...
<#
.SYNOPSIS
    Build and serve the DomainDetective website.
...
.PARAMETER Skip
    Skip the specified pipeline tasks (comma/semicolon separated), for example: optimize,doctor.
