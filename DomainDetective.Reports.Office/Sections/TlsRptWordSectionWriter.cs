...
public static class TlsRptWordSectionWriter
{
    ...
    public static void Write(WordDocument doc, WordList headings, int baseLevel, DomainDetective.Views.TlsRptInfo tlsrpt, string domain, ReportScope scope, bool showInfoFindings, bool includeNarrative = true)
    {
        ...
        t.Rows[2].Cells[1].Paragraphs[0].Text = tlsrpt.IsCnameResolved ? "Yes" : "No";
        t.Rows[3].Cells[0].Paragraphs[0].Text = "CNAME TTL (s)";
        t.Rows[3].Cells[1].Paragraphs[0].Text = tlsrpt.CnameTtl?.ToString() ?? "-";
        t.Rows[4].Cells[0].Paragraphs[0].Text = "Multiple Records";
        t.Rows[4].Cells[1].Paragraphs[0].Text = tlsrpt.MultipleRecords ? "Yes" : "No";
        t.Rows[5].Cells[0].Paragraphs[0].Text = "mailto: rua";
        t.Rows[5].Cells[1].Paragraphs[0].Text = (tlsrpt.MailtoRua?.Count ?? 0).ToString();
        t.Rows[6].Cells[0].Paragraphs[0].Text = "http: rua";
        t.Rows[6].Cells[1].Paragraphs[0].Text = (tlsrpt.HttpRua?.Count ?? 0).ToString();
        t.Rows[7].Cells[0].Paragraphs[0].Text = "Invalid URIs";
        t.Rows[7].Cells[1].Paragraphs[0].Text = (tlsrpt.InvalidRua?.Count ?? 0).ToString();
        t.Rows[8].Cells[0].Paragraphs[0].Text = "Status";
        t.Rows[8].Cells[1].Paragraphs[0].Text = tlsrpt.Status ?? string.Empty;
